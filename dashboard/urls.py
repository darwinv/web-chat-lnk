...
urlpatterns = [
    ...
    url(r'^actor/specialists/(?P<pk>[0-9]+)$', views.actors.Specialist().detail, name='actor-specialists-detail'),
    url(r'^actor/specialists/edit/(?P<pk>[0-9]+)$', views.actors.Specialist().edit, name='actor-specialists-edit'),
    ...
    url(r'^actor/clients/(?P<pk>[0-9]+)$', views.actors.Client().detail, name='actor-clients-detail'),
    url(r'^actor/clients/edit/(?P<pk>[0-9]+)$', views.actors.Client().edit, name='actor-clients-edit'),
    ...
    url(r'^actor/sellers/(?P<pk>[0-9]+)$', views.actors.Seller().list, name='actor-sellers-detail'),
    url(r'^actor/sellers/edit/(?P<pk>[0-9]+)$', views.actors.Seller().list, name='actor-sellers-edit'),
    ...
    url(r'^actor/administrators/(?P<pk>[0-9]+)$', views.actors.Administrator().list, name='actor-administrators-detail'),
    url(r'^actor/administrators/edit/(?P<pk>[0-9]+)$', views.actors.Administrator().list, name='actor-administrators-edit'),
