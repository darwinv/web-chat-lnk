...
urlpatterns = [
    ...
    url(r'^actor/specialists/delete/$', actors.Client().delete, name='actor-specialists-delete'),
    ...
    url(r'^actor/sellers/create/$', actors.Seller().list, name='actor-sellers-create'),
