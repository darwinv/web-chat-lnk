...
class SpecialistForm(ModelForm):
    #category = forms.CharField(widget=forms.TextInput(attrs={'placeholder': _('user').title(), 'class': 'form-control'}) )
...
#     class Meta:
#         model   = User
#         fields  = ['name','nick', 'bussiness_name', 'cv']

# class FormAB(FormA, FormB): language = forms.CharField(required=True, label=_(u'Language'))
